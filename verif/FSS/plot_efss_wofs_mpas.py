...
if ((pmthd == 0) or (pmthd == 1)):
    ...
    heatmap_width_inten_diff_mpas(outdir, wefbs, wefbsr, mefbs,mefbsr,wscales[0,0,:],wfcst_thlds[0,0,0,:],exper,year1,year2)
...
if ((pmthd == 0) or (pmthd == 2)):
    ...
    time_series_efss_mpas(outdir, wefbs[:, :, :,wd,th], wefbsr[:,:,:,wd,th], wfbs[:,:,:,:,wd,th], wfbsr[:,:,:,:,wd,th],
            mefbs[:, :, :, wd,th], mefbsr[:,:,:,wd,th], mfbs[:,:,:,:,wd,th], mfbsr[:,:,:,:,wd,th], wscales[0,0,wd], wfcst_thlds[0,0,0,th], exper, year1, year2)
