...
# o submit_a_jobscript       # Create a job script base on the template and submit the job script, old version
# o check_job_status
...
function submit_a_jobscript {
    ...
    #
    # NOTE: Will be used by the cold-started CONUSE workflow
    #
    if [[ $# -ne 6 ]]; then
