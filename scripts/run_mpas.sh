...
#        *wofs_mpas.grid.nc
#
#    2.3 tables for Thompson cloud microphysics scheme
...
#
#    2.4 MPASS run-time static files
...
#        exec
#        scripts
#        templates (link needed files use script lnwrkfiles.sh, see README in that directory)
#
