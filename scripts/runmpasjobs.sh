...
function usage {
    ...
    echo -e "               ${BROWN}atpost${NC}: To schedule tasks post, plot, diag, verif, and snd using linux utility ${PURPLE}at${NC} on the post-processing machine."
    echo    " "
    echo    "    OPTIONS:"
    ...
    echo -e "              -p  machine         Post-processing machine (for tasks: post, plot, diag, snd and verif), default: ${PURPLE}wof-epyc8${NC}."
    echo    " "
    echo    "   DEFAULTS:"
    ...
    echo    "              post_dir   = ${LIGHT_BLUE}\${post_dir}${NC}"
    echo    " "
